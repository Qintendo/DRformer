...
class Options():
    ...
    def init(self, parser):
        ...
        parser.add_argument('--pretrain_weights', type=str, default='./log/DRFormer_istd/models/model_latest.pth',
        ...
        parser.add_argument('--arch', type=str, default='DRFormer', help='architecture')
